...
if __name__ == '__main__':
    ...
    print(f"There are {color_text(len(network.find_group(0)), 32)} programs connected to the program with ID 0.")
    print(f"There are {color_text(len(network.find_groups()), 32)} unconnected groups in the network.")
