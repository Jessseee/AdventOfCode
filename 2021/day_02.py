...
if __name__ == "__main__":
    ...
    print(f'\nAccording to the {c("first", 33)} interpretation of the instructions')
    print(f"The end position of the submarine will be: {c(pos, 32)}")
    print(f"The product of these values is: {c(pos[0] * pos[1], 32)}")
    ...
    print(f'\nAccording to the {c("second", 33)} interpretation of the instructions')
    print(f"The end position of the submarine will be: {c(pos, 32)}")
    print(f"The product of these values is: {c(pos[1] * pos[2], 32)}")
