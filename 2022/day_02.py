...
if __name__ == '__main__':
    ...
    print("Using the interpreted strategy guide the tournament score is: ",
          color_text(rock_paper_scissors(instructions, results), Color.GREEN))

    results = {'A': {'Y': 4, 'Z': 8, 'X': 3}, 'B': {'X': 1, 'Y': 5, 'Z': 9}, 'C': {'Z': 7, 'X': 2, 'Y': 6}}
    print("Using the actual strategy guide the tournament score is: ",
          color_text(rock_paper_scissors(instructions, results), Color.GREEN))
